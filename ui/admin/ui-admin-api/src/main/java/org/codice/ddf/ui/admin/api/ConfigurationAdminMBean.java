...
public interface ConfigurationAdminMBean {
    ...
    /**
     * Enables a previously disabled {@link Source} to be able to be queried by the
    ...
    /**
     * Disables a {@link Source} to prevent it from being queried by the {@link CatalogFramework}
